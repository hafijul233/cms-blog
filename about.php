...
<html lang="en-US">
  <head>
    ...
    <title><?php if(empty($_SESSION['fullname']) == TRUE) {echo "ABOUT | User's BLog"; }else { echo $_SESSION['fullname'] . " | ABOUT"; } ?></title>
      ...
      <nav class="navbar navbar-inverse header"  >
        ...
        <div class="collapse navbar-collapse" id="collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="about.php"><span class="glyphicon glyphicon-question-sign"></span> About Us</a></li>
      ...
      <div class="col-lg-offset-1 col-lg-3">
        <div class="row">
          <div class="col-lg-12">
            ...
            <img class="img-responsive img-circle img-icon" src="postcontent/profile-pic/<?php if (empty($_SESSION['profilepic']) == TRUE) {
                  $_SESSION['profilepic'] = NULL;
              } else {
                  echo $_SESSION['profilepic'];
              } ?>" alt="<?php if (empty($_SESSION['profilepic']) == TRUE) {
                  $_SESSION['profilepic'] = NULL;
              } else {
